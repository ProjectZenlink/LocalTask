            ...
            <div key={l.id} className="flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-hair px-5 py-3.5 last:border-b-0">
              <div className="min-w-0 flex-1">
                <p className="flex items-center gap-2 truncate text-sm font-medium text-ink">
                  {personOf(l).name}
                  <span className={`rounded-full border px-1.5 py-0.5 font-mono text-[10px] uppercase tracking-wider ${
          ...
          <div className="w-full max-w-sm rounded-2xl border border-hair bg-white p-5 shadow-sm" onClick={e => e.stopPropagation()}>
            ...
            {invLink ? (
              <>
                ...
                <p className="mb-3 break-all rounded-xl border border-hair bg-paper/60 px-3 py-2 font-mono text-xs">
                  <a href={invLink} target="_blank" rel="noreferrer" className="text-petrol underline underline-offset-2">{invLink}</a>
                </p>
                <div className="flex gap-2">
