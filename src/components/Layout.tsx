...
const COPY = {
  en: {
    tabs: { offers: 'Offers', tasks: 'Tasks', accounts: 'Accounts', wallet: 'Wallet', me: 'Profile' },
  ...
  zh: {
    tabs: { offers: '任务邀约', tasks: '我的任务', accounts: '账号', wallet: '钱包', me: '我的资料' },
...
function LayoutInner({ children }: { children: ReactNode }) {
  ...
  const TABS = [
    { to: '/offers', label: t.tabs.offers, icon: Inbox },
    { to: '/tasks', label: t.tabs.tasks, icon: ListChecks },
    { to: '/accounts', label: t.tabs.accounts, icon: KeyRound },
