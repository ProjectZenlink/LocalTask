                  ...
                  {({ isActive }) => (
                    <>
                      ...
                      <span className="relative">
                        ...
                        {tb.badge > 0 && (
                          <span className="absolute -right-2 -top-1 inline-flex min-w-[0.95rem] items-center justify-center rounded-full bg-petrol px-0.5 font-mono text-[10px] leading-[0.95rem] text-paper">{tb.badge}</span>
                        )}
                      </span>
