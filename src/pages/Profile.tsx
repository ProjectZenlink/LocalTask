...
const COPY = {
  ...
  zh: {
    ...
    saved: '已保存。',
    payHead: '收款方式',
    payIntro1: `可以同时保存多种收款方式——加密钱包和 ${PP} 可并存。标记为`, snapWhat: '什么是快照保护?', pcrHintShort: '修改需经你的 AM 或管理员快速审核。',
    payIntro2: '的会在任务指派给你的那一刻被快照进任务。',
    payEmpty: '还没有收款方式。添加一个之前无法给你派任务。',
    defaultChip: '默认', setDefault: '设为默认', remove: '删除', crypto: '加密钱包',
    mCrypto: '加密钱包', mCryptoHint: `${USDT} · ${USDC} · ${ETH_W}`, mPaypal: PP, mPaypalHint: '个人邮箱',
    netLabel: '网络与币种', addrLabel: '钱包地址', addrPh: '先选择上面的选项',
    ppLabel: `${PP} 邮箱`,
    ppHint: `请使用你本人实名的 ${PP} 账号，必须与 KYC 身份一致。`,
    errPaypal: `这个 ${PP} 邮箱看起来不对。`,
    errPick: '请选择一种加密收款选项。',
