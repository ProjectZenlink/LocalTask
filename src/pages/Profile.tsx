...
const COPY = {
  en: {
    ...
    enhLine: 'Enhanced KYC', enhGo: 'Complete Enhanced KYC to unlock your signup bonus →',
    ...
    workHead: 'Work email', workHint: 'Set up and managed by your account manager.',
  ...
  zh: {
    ...
    enhLine: 'Enhanced KYC', enhGo: '完成 Enhanced KYC,解锁注册奖励提现 →',
    ...
    workHead: '工作邮箱', workHint: '由你的账户经理配置和维护。',
...
export default function Profile() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* Work email(AM 代管,本人只读) */}
      {profile.work_email && (
        <Card className="mb-5 p-5">
          <SectionTitle>{t.workHead}</SectionTitle>
          <p className="break-all font-mono text-sm text-ink">{profile.work_email}</p>
          {profile.work_email_password && (
            <p className="mt-1 font-mono text-xs text-muted"><SecretText value={profile.work_email_password} /></p>
          )}
