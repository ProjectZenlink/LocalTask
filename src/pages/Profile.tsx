  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <Card className="mb-5 p-5">
        ...
        <Button onClick={() => save('contact', { contact_whatsapp: whatsapp.trim() || null, contact_telegram: telegram.trim() || null })}
      ...
      <Card className="mb-5 p-5">
        ...
        <Button variant="ghost" onClick={() => save('account', { display_name: displayName.trim(), full_name: fullName.trim() })}
