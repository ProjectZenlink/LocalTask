...
const COPY = {
  en: {
    ...
    steps: [
      ...
      { n: '3', h: 'Accept = commitment', d: 'On accept, the task moves to your Tasks tab and its LT Coins lock into your Wallet (1 LT Coin = $1). Your payout details are snapshotted at this moment for your protection.' },
    ...
    faq: [
      ...
      { q: 'What happens if my work is rejected?', a: 'You get the reviewer’s notes and can resubmit a new version. LT Coins stay locked until a version is approved.' },
    ],
  },
  zh: {
    ...
    steps: [
      ...
      { n: '3', h: '接受 = 承诺', d: '接受后任务进入「我的任务」，对应 LT Coins 锁进钱包（1 LT Coin = 1 美元）。此刻你的收款信息会被快照存档，保护你。' },
    ...
    faq: [
      ...
      { q: '提交被驳回怎么办？', a: '你会看到审核意见，可以修改后重新提交。LT Coins 保持锁定，直到某个版本通过。' },
    ],
  },
}
