...
export default function Offers() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {verified && !profile?.is_suspended && !profile?.payout_address && (
        <Alert tone="warning">
          Set your payout wallet to accept offers.{' '}
                ...
                <div className="mt-4 flex flex-col gap-2 sm:flex-row">
                  ...
                  {left && (
                    <>
                      ...
                      <Button disabled={busyId === o.id || !profile?.payout_address} onClick={() => respond(o.id, true)} className="w-full sm:w-auto">
      ...
      <div className="mt-8">
        ...
        <p className="text-sm leading-relaxed text-muted">
          ...
          Once you accept, the task moves to your Tasks tab, its LT lock into your Coins balance (1 LT = $1),
          and delivery is expected. LT unlock when your work is approved.
        </p>
      </div>
    </div>
  )
