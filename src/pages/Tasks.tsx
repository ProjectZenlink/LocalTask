...
const COPY = {
  en: {
    ...
    due: 'due',
    sections: {
      in_progress: ['In progress', 'Nothing in progress. Tasks your manager assigns land here.'],
      under_review: ['Under review', 'No submissions waiting on review.'],
      pending_payment: ['Awaiting payment', 'No approved tasks awaiting payment.'],
    },
  },
  zh: {
    ...
    due: '截止',
    sections: {
      in_progress: ['进行中', '还没有进行中的任务。AM 指派后会出现在这里。'],
