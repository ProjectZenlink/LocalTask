...
const COPY = {
  en: {
    title: 'Enhanced KYC',
    sub: 'Unlock your signup bonus withdrawal with one extra verification step.',
  ...
  zh: {
    ...
    goBase: '去完成基础验证',
    pendingT: '审核中',
    pendingBody: '你的 Enhanced KYC 正在审核。通过后就可以申请提现注册奖励。',
    verifiedT: 'Enhanced KYC 已通过',
    verifiedBody: '一切就绪——去钱包页申请提现注册奖励吧。',
    goWallet: '去钱包',
      ...
      {baseStatus !== 'verified' ? (
        ...
        <Card className="p-5">
          ...
          <div className="mb-5">
            ...
            <input value={ssn} inputMode="numeric" maxLength={11} placeholder="•••••••••"
