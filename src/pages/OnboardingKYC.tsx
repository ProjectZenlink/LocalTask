...
const COPY = {
  ...
  zh: {
    ...
    ssnLabel: '社会安全号 SSN（9 位数字）',
    ssnHint: '加密保存，之后不会再显示。仅用于身份核验。',
    busy: '提交中…', cta: '提交审核',
    notReady: '请上传全部四份材料并填写 9 位 SSN。',
    docs: {
