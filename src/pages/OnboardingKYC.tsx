        ...
        return (
          <div key={d.key} className="mb-5 rounded-xl border border-hair bg-surface p-4">
            ...
            <input
              ...
              className="hidden"
            />
            {/* v85.2:自绘触发钮 —— 原生控件按手机系统语言渲染(小同事中文机实测),换装后恒英文 */}
            <label htmlFor={`kyc-file-${d.key}`}
            ...
            {!files[d.key] && (
              <span className="ml-3 align-middle font-mono text-xs text-muted">No file selected</span>
            )}
