...
const COPY = {
  en: {
    ...
    sub: 'All your earnings in one place — bundle them into a payout request for your AM.',
  ...
  zh: {
    ...
    sub: '全部收入统一进钱包,一键打包成提现工单发给专属 AM。',
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <Card className="mb-5 p-5">
        <div className="flex items-baseline justify-between gap-3">
          ...
          <span className="font-mono text-lg text-ink">{usd(availTotal)} <span className="text-xs text-faint">· {lt(availTotal)}</span></span>
        </div>
