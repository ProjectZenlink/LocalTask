...
const COPY = {
  en: {
    ...
    steps: [
      { k: 'Lock', cls: 'text-pending-text', d: 'Accept a task → its LT Coins lock into your balance. That’s the platform’s written record of what you’re owed.' },
  ...
  zh: {
    ...
    how: 'LT Coins 是怎么运作的',
    steps: [
      { k: '锁定', cls: 'text-pending-text', d: '接受任务后，对应 LT Coins 锁进你的余额，这是平台对你应收款的书面记录。' },
