...
const COPY = {
  en: {
    ...
    sub: "LocalTask Coins (LT) track what you're owed — 1 LT = $1. Real money goes straight from the client to you.",
    ...
    ledgerNote: 'LT is a display ledger, not a token or an in-app balance you withdraw. LocalTask never holds your funds — every payment travels client → you, and the task only closes after you confirm receipt.',
  ...
  zh: {
    ...
    sub: 'LocalTask Coins（LT）记录平台欠你的钱，1 LT = 1 美元。真钱由客户直接打到你的钱包或 PayPal。',
    ...
    how: 'LT 是怎么运作的',
    steps: [
      { k: '锁定', cls: 'text-pending-text', d: '接受任务后，对应 LT 锁进你的余额，这是平台对你应收款的书面记录。' },
      { k: '解锁', cls: 'text-petrol', d: '任务审核通过后 LT 解锁，客户会被要求直接付款到你的钱包或 PayPal。' },
      { k: '结清', cls: 'text-verified-text', d: '你确认到账后，这些 LT 结清（销毁）。已结清的 LT = 真正到手的钱。' },
    ],
    ledgerNote: 'LT 只是记账展示，不是代币，也不是可提现的应用内余额。LocalTask 从不经手你的钱——每笔付款都是客户直接付给你，任务也只有在你确认收到后才会关闭。',
    settledHead: '结清记录',
