...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: 'How do I reach my manager?', a: "Built-in messages plus WhatsApp or Telegram. Civility runs both ways — abusive messages are blocked and logged, on either side of the table." },
...
const STEPS4: [string, string, string][] = [
  ...
  ['04', 'Get paid', 'We send the payment straight to your wallet. Fast, clean, closed.'],
]
      ...
      <header className="sticky top-0 z-30 border-b border-hair bg-paper/85 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Link to="/signup" className="rounded-lg bg-petrol px-4 py-2 font-display text-sm font-medium text-paper transition hover:bg-petrol-hover">
              Apply now
            </Link>
          </div>
        </div>
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div>
              ...
              <p className="ld-fade mt-6 max-w-md text-base leading-relaxed text-muted" style={{ animationDelay: '280ms' }}>
                Structured tasks, paid in USD. Clear scope,
                <span className="font-medium text-petrol"> locked payout, fast settlement</span>.
              </p>
        ...
        <Rv delay={140} className="relative mt-10 overflow-hidden rounded-2xl bg-petrol p-8 shadow-[0_20px_56px_rgba(36,75,77,0.32)] sm:p-10">
          ...
          <div className="relative grid sm:grid-cols-3 sm:gap-8">
            <div className="border-b border-paper/15 py-5 first:pt-0 sm:border-0 sm:py-0">
              <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-paper/75">Priced in USD</p>
            ...
            <div className="border-b border-paper/15 py-5 sm:border-0 sm:py-0">
              <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-paper/75">Paid your way</p>
            ...
            <div className="py-5 last:pb-0 sm:border-0 sm:py-0">
              <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-paper/75">Straight to you</p>
              <p className="mt-2 text-sm leading-relaxed text-paper">Payouts go to your own wallet — we never hold your money.</p>
            </div>
          </div>
