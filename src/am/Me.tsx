...
const COPY = {
  zh: { title: '我的资料', sub: '你的身份、数据一览与联系方式。',
        ...
        quick: '快捷入口', qFl: '我的 Freelancer', qPool: '人才库', qWallet: '钱包', qPwd: '修改密码',
  ...
  en: { title: 'My profile', sub: 'Your identity, numbers at a glance and contact info.',
        ...
        quick: 'Shortcuts', qFl: 'My freelancers', qPool: 'Pool', qWallet: 'Wallet', qPwd: 'Change password',
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <Card className="mb-4 p-5">
        ...
        <div className="flex flex-wrap gap-2.5">
          ...
          <Link to="/change-password"><Button variant="ghost" className="px-3.5 py-2 text-sm">{t.qPwd}</Button></Link>
        </div>
      </Card>
