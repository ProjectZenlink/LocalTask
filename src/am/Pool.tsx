...
const COPY = {
  zh: {
    ...
    search: '按名字搜索…', name: '姓名', kyc: 'KYC', load: '活跃/完成', qsa: '质/速/态', strikes: 'Strikes', owner: '归属', act: '',
  ...
  en: {
    ...
    search: 'Search by name…', name: 'Name', kyc: 'KYC', load: 'Active/Done', qsa: 'Q/S/A', strikes: 'Strikes', owner: 'Owner', act: '',
