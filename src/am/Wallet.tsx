  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-3 overflow-hidden rounded-2xl bg-petrol p-6 text-paper shadow-sm">
        <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-paper/75">{t.balance}</p>
        <p className="mt-1 font-display text-4xl font-medium tracking-tight">{usd(total - paid)}</p>
        <p className="mt-2 font-mono text-xs text-paper/75">{t.total} {usd(total)} · {t.paid} {usd(paid)}</p>
      </div>
