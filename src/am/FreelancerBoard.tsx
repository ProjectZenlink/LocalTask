    ...
    <div className="mx-auto max-w-3xl">
      ...
      <Card className="p-5">
        {PLATFORMS.map(type => {
          ...
          const badgeTone = state === 'green' ? 'verified' : (state === 'grey' || state === 'reopened') ? 'unverified' : 'pending'
          const badgeLabel = state === 'reopened' ? t.stReopen : state === 'green' ? t.stGreen : state === 'review' ? t.stReview : state === 'yellow' ? t.stYellow : t.stGrey
          return (
