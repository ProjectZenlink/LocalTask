...
export default function AmTodayDock({ amId }: { amId: string }) {
  ...
  return (
    <div className={`fixed bottom-5 z-30 w-64 rounded-2xl border border-hair bg-surface p-4 shadow-[0_16px_48px_rgba(26,32,30,0.18)] transition-[right] duration-300 ${dockOpen ? 'right-4 lg:right-[456px]' : 'right-5'}`}>
