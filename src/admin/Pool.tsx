...
const COPY = {
  zh: {
    ...
    search: '按名字搜索…', name: '姓名', kyc: 'KYC', combo: '收款组合',
    active: '活跃', done: '完成', qsa: '质/速/态', strikes: 'Strikes', contact: '联系',
    assign: '派任务', assignTitle: '发 Offer 给', pickTask: '选择任务(未指派)', noTasks: '没有未指派的任务。先去「任务」页新建。', note: 'Offer 备注(可选)', hours: '过期时长(小时)', send: '发 Offer', sent: '已发 Offer:', pause: '暂停', resume: '恢复', block: '封禁', unblock: '解封',
  ...
  en: {
    ...
    search: 'Search by name…', name: 'Name', kyc: 'KYC', combo: 'Payout combo',
    active: 'Active', done: 'Done', qsa: 'Q/S/A', strikes: 'Strikes', contact: 'Contact',
    assign: 'Assign', assignTitle: 'Send offer to', pickTask: 'Pick a task (unassigned)', noTasks: 'No unassigned tasks. Create one on the Tasks page.', note: 'Offer note (optional)', hours: 'Expires in (hours)', send: 'Send offer', sent: 'Offer sent:', pause: 'Pause', resume: 'Resume', block: 'Block', unblock: 'Unblock',
        ...
        {filtered.length === 0 ? (
          ...
          <table className="w-full border-collapse">
            <thead className="border-b border-hair">
              <tr>
                <Th>{t.name}</Th><Th>{t.kyc}</Th><Th>{t.combo}</Th>
