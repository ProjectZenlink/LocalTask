...
const COPY = {
  zh: {
    title: '客户管理', sub: '每个客户由一位账户经理(AM)负责——线下签约、任务口径、催款都走 AM。客户没有账号,对 freelancer 完全隐藏。',
    add: '＋ 新建客户', company: '公司名称(必填)', contact: '账户经理(AM,负责这个客户的人)', info: 'AM 联系方式(微信 / 邮箱 / WhatsApp)',
  ...
  en: {
    title: 'Clients', sub: 'Each client is owned by an account manager (AM) — contracts, task specs and payment chasing all go through them. Clients have no accounts and are hidden from freelancers.',
    add: '＋ New client', company: 'Company name (required)', contact: 'Account manager (AM who owns this client)', info: 'AM contact (WeChat / email / WhatsApp)',
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-0.5 font-mono text-xs text-faint">
                  {c.contact_name ? 'AM: ' + c.contact_name : '—'}{c.contact_info ? ' · ' + c.contact_info : ''} · {t.joined} {dateShort(c.created_at)}
                </p>
