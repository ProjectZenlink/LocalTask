...
import { usd, dateShort, dateTimeShort, waLink, tgLink, xLink, signFiles, safeFileName, fileNameFromPath, isImagePath } from '../lib/format'
...
const COPY = {
  zh: {
    ...
    basics: '基本资料', legal: '法定姓名', dob: '出生日期', addr: '地址', ssn: 'SSN', only4: '仅后四位', joined: '注册',
    workT: '工作邮箱', workEmail: '邮箱地址', workPwd: '邮箱密码', workHint: '由 AM 注册并维护;freelancer 端只读展示。', workSave: '保存', workSaved: '已保存 ✓',
    enhKyc: 'Enhanced KYC', bonusT: '注册奖励', bonusState: '状态',
  ...
  en: {
    ...
    basics: 'Basics', legal: 'Legal name', dob: 'Date of birth', addr: 'Address', ssn: 'SSN', only4: 'last 4 only', joined: 'Joined',
    ...
    enhKyc: 'Enhanced KYC', bonusT: 'Signup bonus', bonusState: 'State',
