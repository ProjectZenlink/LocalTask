...
const COPY = {
  zh: {
    ...
    owner: '归属 AM', ownerNone: '— 未归属 —', recordsT: '账号资料(由归属 AM 维护)', recEmpty: '暂无账号资料。', kyc: 'KYC 材料', kycEmpty: '没有提交记录。', submitted: '提交于', reviewed: '审核于', reason: '驳回原因:',
    viewKyc: '查看材料',
  ...
  en: {
    ...
    owner: 'Owner AM', ownerNone: '— Unassigned —', recordsT: 'Account records (maintained by owner AM)', recEmpty: 'No account records.', kyc: 'KYC documents', kycEmpty: 'No submissions.', submitted: 'Submitted', reviewed: 'Reviewed', reason: 'Rejection:',
