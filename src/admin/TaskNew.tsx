...
const COPY = {
  zh: {
    ...
    taskTitle: '任务标题', tags: '标签(可选,回车或逗号添加,如 Paypal)', desc: '任务说明(可贴链接,freelancer 端可点击)',
    ...
    vClient: '请选择账户经理。', vTitle: '请填任务标题。', vCriteria: '验收标准必填。', vAmount: '金额需大于 0。',
  ...
  en: {
    ...
    taskTitle: 'Title', tags: 'Tags (optional — Enter or comma to add, e.g. Paypal)', desc: 'Description (links are clickable on the freelancer side)',
    ...
    vClient: 'Pick an account manager.', vTitle: 'Enter a title.', vCriteria: 'Acceptance criteria are required.', vAmount: 'Amount must be greater than 0.',
