...
import { PageHeading, Card, Button, Alert, Label, Input, FilePick } from '../components/ui'
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <Card className="p-5">
        ...
        <div className="mb-4">
          <Label>{t.files}</Label>
          <FilePick id="tasknew-files" multiple label="Choose files" empty="No files selected"
