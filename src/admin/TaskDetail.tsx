...
const COPY = {
  zh: {
    ...
    tx: '交易',
    back: '← 任务列表', tags: '标签', dlgCancel: '取消', copyLink: '复制客户链接', copied: '已复制 ✓', edit: '编辑任务', save: '保存修改', saving: '保存中…', cancelEdit: '取消编辑', addFiles: '追加附件(可多选)', tagHint: '标签(回车或逗号添加)', rate: '三维评分(freelancer 不可见)', quality: '质量', speed: '速度', attitude: '态度',
  ...
  en: {
    ...
    tx: 'Transaction',
    back: '← All tasks', tags: 'Tags', dlgCancel: 'Cancel', copyLink: 'Copy client link', copied: 'Copied ✓', edit: 'Edit task', save: 'Save changes', saving: 'Saving…', cancelEdit: 'Cancel editing', addFiles: 'Add attachments (multiple)', tagHint: 'Tags (Enter or comma to add)', rate: 'Rating (never visible to the freelancer)', quality: 'Quality', speed: 'Speed', attitude: 'Attitude',
