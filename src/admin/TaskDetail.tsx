...
const COPY = {
  zh: {
    ...
    tx: '交易',
    back: '← 任务列表', tags: '标签', dlgCancel: '取消', rate: '三维评分(freelancer 不可见)', quality: '质量', speed: '速度', attitude: '态度',
  ...
  en: {
    ...
    tx: 'Transaction',
    back: '← All tasks', tags: 'Tags', dlgCancel: 'Cancel', rate: 'Rating (never visible to the freelancer)', quality: 'Quality', speed: 'Speed', attitude: 'Attitude',
