...
import { money, usd, lt, taskMoney, dateShort, dateTimeShort, timeLeft, txUrl, shortHash, signTaskFiles, fileNameFromPath, isImagePath, typeLabel } from '../lib/format'
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <Card className="mb-5 p-5">
        ...
        {task.task_type && (
          <KV k={t.typeK}>
            <span className="rounded-full border border-hair bg-paper px-2 py-0.5 font-mono text-[10px] uppercase tracking-wider text-muted">{typeLabel(task.task_type, lang)}</span>
          </KV>
        )}
