...
const COPY = {
  zh: {
    notFound: '任务不存在', client: '客户', amount: '金额', payMethod: '收款方式', deadline: '截止', created: '创建',
    assignee: '接单人', payout: '收款地址(快照)', none: '—',
    brief: '任务说明', files: '附件', criteria: '验收标准',
    match: '可派的 Freelancer(已认证 · 开着接单 · 已设钱包)',
    matchEmpty: '暂无可派的人。可能没人开着接单,或还没设收款钱包。',
  ...
  en: {
    notFound: 'Task not found', client: 'Client', amount: 'Amount', payMethod: 'Payout method', deadline: 'Due', created: 'Created',
    assignee: 'Assignee', payout: 'Payout address (snapshot)', none: '—',
    brief: 'Brief', files: 'Attachments', criteria: 'Acceptance criteria',
    match: 'Available freelancers (verified · open to work · wallet set)',
    matchEmpty: 'Nobody available — no one is open to work, or payout wallets are missing.',
